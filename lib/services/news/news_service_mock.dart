...
class NewServiceMock implements NewService {
  ...
  Future<News> updateNewsStatus(News news) async{
    //print(news.status);
    News _news = _news_list.firstWhere((element) => element.postID == news.postID);
