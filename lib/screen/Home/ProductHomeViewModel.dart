...
class ProductHomeScreenViewModel extends Viewmodel {
  final HomeViewmodel _homeViewmodel;
  
  ProductHomeScreenViewModel({homeViewmodel}) : _homeViewmodel = homeViewmodel {
    _loadHomeProduct();
    _loadAllUsers();
  }
  ...
  void _loadHomeProduct() => update(() async => _products = await service.getProductWithoutUser());
